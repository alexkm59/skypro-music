...
setTimeout(()=>{
  ...
  return(
    ...
    // { trackName, trackAuthor, album, trackTime}
                  ...
                  <div className="playlist__track track">
                    ...
                    {/* <SkeletonTheme baseColor="#cf6565" highlightColor="#ff0">
                      ...
                      <div className="track__title-image">
                        {isLoading ? <svg className="track__title-svg" alt="music">
                      ...
                      <SkeletonTheme baseColor="#313131" highlightColor="#fff" height={20} width={356}>
                        {isLoading ? <a className="track__title-link" href="http://">{props.trackName} <span className="track__title-span"></span></a> : <Skeleton/> }
                        </SkeletonTheme>
                      </div>
                    </div>
                    <div className="track__author">
                    <SkeletonTheme baseColor="#313131" highlightColor="#fff" height={20} width={272}>
                        {isLoading ? <a className="track__author-link" href="http://">{props.trackAuthor}</a> : <Skeleton/> }
                        </SkeletonTheme>
                         
                    </div>
                    <div className="track__album">
                    <SkeletonTheme baseColor="#313131" highlightColor="#fff" height={20} width={250}>
                        {isLoading ? <a className="track__album-link" href="http://">{props.album}</a> : <Skeleton/> }
                        </SkeletonTheme>
                    ...
                    <div className="track__time">
                      ...
                      <span className="track__time-text"> {isLoading ? props.trackTime : '0.00'}</span>
